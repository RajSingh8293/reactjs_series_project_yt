            ...
            <div className='w-full lg:max-w-3xl md:max-w-xl sm:max-w-sm bg-white  rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2'>
                ...
                <div className='hidden lg:flex flex-col justify-center bg-linear-to-br from-gray-700  to-gray-800 text-white p-12 relative overflow-hidden'>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className='my-6 text-sm text-blue-100'>Login to access your account, manage your orders, wishlist, and enjoy seamless shopping experience.</p>
                        <img src="https://cdn-icons-png.flaticon.com/512/891/891462.png" alt="shopping"
                            className='w-72 my-10 drop-shadow-2xl'
                        />
                    </div>
                ...
                <div className='p-8 md:p-12 flex flex-col justify-center'>
                    <div className='text-center flex justify-center items-center flex-col gap-2'>
                        ...
                        <p className='text-gray-500 mt-3'>Welcome back! Please login to your account.</p>
                    ...
                    <form onSubmit={handleSubmit} className='mt-10 space-y-6'>
                        ...
                        <button type='submit' className=" w-full bg-black hover:bg-gray-700 text-white  py-4 rounded-2xl  font-semibold text-sm  shadow-lg hover:shadow-xl transition duration-300">Login
                        </button>
