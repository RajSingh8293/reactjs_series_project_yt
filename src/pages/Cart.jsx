                        ...
                        cartItems.length === 0 ?
                            ...
                            <div className="grid  grid-cols-1 lg:grid-cols-3 gap-8">
                                <div className="lg:col-span-2 space-y-5">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center gap-3 mt-4">
                                                        <button
                                                            ...
                                                            className='w-8 h-8 rounded-full bg-gray-200 hover:bg-gray-300 text-base font-bold flex items-center justify-center'>
                                    ...
                                    <button onClick={() => dispatch(clearCart())} className='border border-black text-black hover:bg-black hover:text-white px-5 py-2.5 rounded-md text-sm font-medium transition duration-300'>
                                        Clear
                                    </button>
                                </div>
                                ...
                                <div className="bg-white rounded-xl shadow-lg p-6 h-fit">
                                    ...
                                    <button className='w-full mt-8 bg-black hover:bg-gray-700 text-white py-3 rounded-xl font-semibold shadow-lg transition duration-300'>
                                        Procced To Checkout
                                    </button>
