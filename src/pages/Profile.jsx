                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className='bg-white rounded-3xl shadow-xl p-8 h-fit'>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            {/* button  */}
                            <button className='mt-6 bg-black hover:bg-gray-700 text-white px-6 py-3 rounded-md text-sm font-semibold flex items-center gap-2
                        ...
                        <div className='mt-10 space-y-3'>
                            <button className='w-full  flex items-center gap-2 bg-gray-100 hover:bg-blue-100  text-gray-700 hover:text-blue-700 px-5 py-4 rounded-2xl transition duration-300'>
                                <FaShoppingBag />
                                My Orders
                            </button>
                            <button className='w-full  flex items-center gap-2 bg-gray-100 hover:bg-pink-100  text-gray-700 hover:text-pink-700 px-5 py-4 rounded-2xl transition duration-300'>
                                <FaHeart />
                                Whishlist
                            </button>
                            <button onClick={logoutUser} className='w-full  flex items-center gap-2 bg-gray-100 hover:bg-red-100  text-red-700 hover:text-red-700 px-5 py-4 rounded-2xl transition duration-300'>
                                <FaSignOutAlt />
                                Logout
                            </button>
